...
test('toggleTodo should toggle the isIncomplete prop of a todo', () => {
...
test('updateTodo should not mutate the original todo array', () => {
    const startTodos = [
        {id: 1, name: 'one', isComplete: false},
        {id: 2, name: 'two', isComplete: false},
        {id: 3, name: 'three', isComplete: false},
...
test('removeTodo should not mutate the original todo array', () => {
    const startTodos = [
        {id: 1, name: 'one', isComplete: false},
        {id: 2, name: 'two', isComplete: false},
        {id: 3, name: 'three', isComplete: false},
